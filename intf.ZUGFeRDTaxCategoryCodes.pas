...
unit intf.ZUGFeRDTaxCategoryCodes;
...
begin
  ...
  if enumValue >= 0 then
    ...
    Result := TZUGFeRDTaxCategoryCodes.Unknown;
end;

class function TZUGFeRDTaxCategoryCodesExtensions.EnumToString(codes: TZUGFeRDTaxCategoryCodes): string;
begin
  Result := GetEnumName(TypeInfo(TZUGFeRDTaxCategoryCodes), Integer(codes));
end;
