...
procedure Map (EnumValue: TZUGFeRDTaxCategoryCodes; StringValue: string); inline;
begin
  TEnumExtensions<TZUGFeRDTaxCategoryCodes>.RegisterMapping(EnumValue, StringValue)
end;
