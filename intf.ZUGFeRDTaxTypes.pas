...
type
  ...
  TZUGFeRDTaxTypesExtensions = class
  public
    class function FromString(const s: string): TZUGFeRDTaxTypes;
    class function EnumToString(codes: TZUGFeRDTaxTypes): string;
  end;

implementation

{ TZUGFeRDTaxTypesExtensions }

class function TZUGFeRDTaxTypesExtensions.EnumToString(
...
class function TZUGFeRDTaxTypesExtensions.FromString(
  const s: string): TZUGFeRDTaxTypes;
var
  enumValue : Integer;
begin
  enumValue := GetEnumValue(TypeInfo(TZUGFeRDTaxTypes), s);
  if enumValue >= 0 then
    Result := TZUGFeRDTaxTypes(enumValue)
  else
    Result := TZUGFeRDTaxTypes.Unknown;
end;
