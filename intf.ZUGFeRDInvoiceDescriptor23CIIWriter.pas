...
begin
  ...
  begin
    ...
    if (tradeLineItem.DesignedProductClassifications.Count > 0) then
    begin
...
begin
  ...
  begin
    ...
    if (tax.AllowanceChargeBasisAmount <> 0.0) and
       (not(Descriptor.Profile in [TZUGFeRDProfile.XRechnung,TZUGFeRDProfile.XRechnung1])) then
    begin
