...
uses
  System.Classes,
  intf.ZUGFeRDInvoiceDescriptor, intf.ZUGFeRDInvoiceDescriptorWriter, intf.ZUGFeRDProfileAwareXmlTextWriter;
...
//  if not (stream.CanWrite and stream.CanSeek) then
//    raise EIllegalStreamException.Create('Cannot write to stream');
//
//  // write data
//  var
