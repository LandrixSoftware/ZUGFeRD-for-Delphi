...
procedure Map (EnumValue: TZUGFeRDReferenceTypeCodes; StringValue: string); inline;
begin
  TEnumExtensions<TZUGFeRDReferenceTypeCodes>.RegisterMapping(EnumValue, StringValue)
end;
