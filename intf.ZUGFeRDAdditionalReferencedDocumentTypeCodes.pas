...
procedure Map (EnumValue: TZUGFeRDAdditionalReferencedDocumentTypeCode; StringValue: string); inline;
begin
  TEnumExtensions<TZUGFeRDAdditionalReferencedDocumentTypeCode>.RegisterMapping(EnumValue, StringValue)
end;
...
begin
  ...
  Map(ReferenceDocument,           '916');
  Map(InvoiceDataSheet,            '130');
  Map(PriceSalesCatalogueResponse, '50');
  Map(Unknown,                     'Unknown');
{.MapEnd}
end;
