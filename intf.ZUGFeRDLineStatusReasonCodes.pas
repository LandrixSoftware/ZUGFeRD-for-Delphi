...
procedure Map (EnumValue: TZUGFeRDLineStatusReasonCodes; StringValue: string); inline;
begin
  TEnumExtensions<TZUGFeRDLineStatusReasonCodes>.RegisterMapping(EnumValue, StringValue)
end;
