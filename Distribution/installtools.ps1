...
Invoke-WebRequest -Uri "https://github.com/ZUGFeRD/mustangproject/releases/download/core-2.1.1/Mustang-CLI-2.11.0.jar" -OutFile mustangproject\Mustang-CLI-2.11.0.jar
