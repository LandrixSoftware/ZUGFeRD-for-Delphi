...
unit intf.ZUGFeRDTaxExemptionReasonCodes;
...
procedure Map (EnumValue: TZUGFeRDTaxExemptionReasonCodes; StringValue: string); inline;
begin
  TEnumExtensions<TZUGFeRDTaxExemptionReasonCodes>.RegisterMapping(EnumValue, StringValue)
end;
...
begin
  ...
  Map(VATEX_EU_79_C,      'VATEX-EU-79-C');
  Map(VATEX_EU_132,       'VATEX-EU-132');
  Map(VATEX_EU_132_1A,    'VATEX-EU-132-1A');
  Map(VATEX_EU_132_1B,    'VATEX-EU-132-1B');
  Map(VATEX_EU_132_1C,    'VATEX-EU-132-1C');
  Map(VATEX_EU_132_1D,    'VATEX-EU-132-1D');
  Map(VATEX_EU_132_1E,    'VATEX-EU-132-1E');
  Map(VATEX_EU_132_1F,    'VATEX-EU-132-1F');
  Map(VATEX_EU_132_1G,    'VATEX-EU-132-1G');
  Map(VATEX_EU_132_1H,    'VATEX-EU-132-1H');
  Map(VATEX_EU_132_1I,    'VATEX-EU-132-1I');
  Map(VATEX_EU_132_1J,    'VATEX-EU-132-1J');
  Map(VATEX_EU_132_1K,    'VATEX-EU-132-1K');
  Map(VATEX_EU_132_1L,    'VATEX-EU-132-1L');
  Map(VATEX_EU_132_1M,    'VATEX-EU-132-1M');
  Map(VATEX_EU_132_1N,    'VATEX-EU-132-1N');
  Map(VATEX_EU_132_1O,    'VATEX-EU-132-1O');
  Map(VATEX_EU_132_1P,    'VATEX-EU-132-1P');
  Map(VATEX_EU_132_1Q,    'VATEX-EU-132-1Q');
  Map(VATEX_EU_143,       'VATEX-EU-143');
  Map(VATEX_EU_143_1A,    'VATEX-EU-143-1A');
  Map(VATEX_EU_143_1B,    'VATEX-EU-143-1B');
  Map(VATEX_EU_143_1C,    'VATEX-EU-143-1C');
  Map(VATEX_EU_143_1D,    'VATEX-EU-143-1D');
  Map(VATEX_EU_143_1E,    'VATEX-EU-143-1E');
  Map(VATEX_EU_143_1F,    'VATEX-EU-143-1F');
  Map(VATEX_EU_143_1FA,   'VATEX-EU-143-1FA');
  Map(VATEX_EU_143_1G,    'VATEX-EU-143-1G');
  Map(VATEX_EU_143_1H,    'VATEX-EU-143-1H');
  Map(VATEX_EU_143_1I,    'VATEX-EU-143-1I');
  Map(VATEX_EU_143_1J,    'VATEX-EU-143-1J');
  Map(VATEX_EU_143_1K,    'VATEX-EU-143-1K');
  Map(VATEX_EU_143_1L,    'VATEX-EU-143-1L');
  Map(VATEX_EU_144,       'VATEX-EU-144');
  Map(VATEX_EU_146_1E,    'VATEX-EU-146-1E');
  Map(VATEX_EU_148,       'VATEX-EU-148');
  Map(VATEX_EU_148_A,     'VATEX-EU-148-A');
  Map(VATEX_EU_148_B,     'VATEX-EU-148-B');
  Map(VATEX_EU_148_C,     'VATEX-EU-148-C');
  Map(VATEX_EU_148_D,     'VATEX-EU-148-D');
  Map(VATEX_EU_148_E,     'VATEX-EU-148-E');
  Map(VATEX_EU_148_F,     'VATEX-EU-148-F');
  Map(VATEX_EU_148_G,     'VATEX-EU-148-G');
  Map(VATEX_EU_151,       'VATEX-EU-151');
  Map(VATEX_EU_151_1A,    'VATEX-EU-151-1A');
  Map(VATEX_EU_151_1AA,   'VATEX-EU-151-1AA');
  Map(VATEX_EU_151_1B,    'VATEX-EU-151-1B');
  Map(VATEX_EU_151_1C,    'VATEX-EU-151-1C');
  Map(VATEX_EU_151_1D,    'VATEX-EU-151-1D');
  Map(VATEX_EU_151_1E,    'VATEX-EU-151-1E');
  Map(VATEX_EU_159,       'VATEX-EU-159');
  Map(VATEX_EU_309,       'VATEX-EU-309');
  Map(VATEX_EU_AE,        'VATEX-EU-AE');
  Map(VATEX_EU_D,         'VATEX-EU-D');
  Map(VATEX_EU_F,         'VATEX-EU-F');
  Map(VATEX_EU_G,         'VATEX-EU-G');
  Map(VATEX_EU_I,         'VATEX-EU-I');
  Map(VATEX_EU_IC,        'VATEX-EU-IC');
  Map(VATEX_EU_O,         'VATEX-EU-O');
  Map(VATEX_EU_J,         'VATEX-EU-J');
  Map(VATEX_FR_FRANCHISE, 'VATEX-FR-FRANCHISE');
  Map(VATEX_FR_CNWVAT,    'VATEX-FR-CNWVAT');
  Map(VATEX_EU_153,       'VATEX-EU-153');
  Map(VATEX_FR_CGI261_1,  'VATEX-FR-CGI261-1');
  Map(VATEX_FR_CGI261_2,  'VATEX-FR-CGI261-2');
  Map(VATEX_FR_CGI261_3,  'VATEX-FR-CGI261-3');
  Map(VATEX_FR_CGI261_4,  'VATEX-FR-CGI261-4');
  Map(VATEX_FR_CGI261_5,  'VATEX-FR-CGI261-5');
  Map(VATEX_FR_CGI261_7,  'VATEX-FR-CGI261-7');
  Map(VATEX_FR_CGI261_8,  'VATEX-FR-CGI261-8');
  Map(VATEX_FR_CGI261A,   'VATEX-FR-CGI261A');
  Map(VATEX_FR_CGI261B,   'VATEX-FR-CGI261B');
  Map(VATEX_FR_CGI261C_1, 'VATEX-FR-CGI261C-1');
  Map(VATEX_FR_CGI261C_2, 'VATEX-FR-CGI261C-2');
  Map(VATEX_FR_CGI261C_3, 'VATEX-FR-CGI261C-3');
  Map(VATEX_FR_CGI261D_1, 'VATEX-FR-CGI261D-1');
  Map(VATEX_FR_CGI261D_1BIS,'VATEX-FR-CGI261D-1BIS');
  Map(VATEX_FR_CGI261D_2, 'VATEX-FR-CGI261D-2');
  Map(VATEX_FR_CGI261D_3, 'VATEX-FR-CGI261D-3');
  Map(VATEX_FR_CGI261D_4, 'VATEX-FR-CGI261D-4');
  Map(VATEX_FR_CGI261E_1, 'VATEX-FR-CGI261E-1');
  Map(VATEX_FR_CGI261E_2, 'VATEX-FR-CGI261E-2');
  Map(VATEX_FR_CGI277A,   'VATEX-FR-CGI277A');
  Map(VATEX_FR_CGI275,    'VATEX-FR-CGI275');
  Map(VATEX_FR_298SEXDECIESA,'VATEX-FR-298SEXDECIESA');
  Map(VATEX_FR_CGI295,    'VATEX-FR-CGI295');
  Map(VATEX_FR_AE,        'VATEX-FR-AE');
  Map(Unknown,            'Unknown');
{.MapEnd}
end;
